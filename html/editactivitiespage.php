...
if (isset($_POST['updateactivities'])) {
    ...
    $sqlupdate  = "UPDATE tbl_activities SET activitiesDescirption='$activitiesDescirption', activitiesFile='$activitiesFile', activitiesImage='$activitiesImage', activitiesStatus='$activitiesStatus' WHERE activitiesID = '$activitiesID' ";

 if(mysqli_query($conn, $sqlupdate)){
    
    echo "<script>
        alert('Success Update, $activitiesTitle.');
        window.location.href = '../html/viewactivitiespage.php';
    </script>";
} else {
    echo "<script type='text/javascript'>alert('$activitiesTitle, Failed Update!');history.go(-1)</script>";
}
}
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="../html/viewactivitiespage.php"><i class="fa fa-table"></i> <span>View Activities</span></a></li>
                ...
                <span>
                    ...
                    <small>
                        <ol class="breadcrumb" style="background-color: rgba(248, 244, 244, 0); position: absolute; top:6%; left:0.3%">
                            ...
                            <li><i class="fa fa-search"></i> View Activities</a></li>
                            <li class="active"><i class="fa fa-edit"></i> Edit Activities</a></li>
...
if (isset($_SESSION["activitiesID"])) {
    $sqlloadactivities = "SELECT * FROM tbl_activities WHERE activitiesID = '$activitiesID'";
    $result = $conn->query($sqlloadactivities);
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            extract($row);
            $activitiesTitle = $row['activitiesTitle'];
            $activitiesDescirption = $row['activitiesDescirption'];
                                ...
                                <div class="box box-danger">
                                    ...
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input type="text" class="form-control" placeholder="Enter ..." name="title" value="<?php echo $activitiesTitle ?>">
                                        </div>
                                        <div class="form-group">
                                            <label>Description</label>
                                            <textarea class="form-control" rows="3" placeholder="Enter ..." name="description" ><?php echo $activitiesDescirption ?></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="radio">
                                            <?php
                                                if ($activitiesStatus == Planning) {
                                            ?>
                                                <label>
                                                    <input type="radio" name="optionsRadios" id="optionsRadios1" value="Planning" checked>
                                                    Planning
                                                </label>
                                            <?php
                                                }else{
                                            ...
                                            ?>
                                                <label>
                                                    <input type="radio" name="optionsRadios" id="optionsRadios2" value="Pending" checked>
                                                    Pending
                                                </label>
                                                <?php
                                                }else{
                                        ...
                                        <div class='col-sm-6'>
                                            <div class="form-group">
                                                <label>Start Date(saved): <?php echo $activitiesStartDate?></label>
                                                
                                            </div>
                                        </div>
                                        <div class='col-sm-6'>
                                            <div class="form-group">
                                                <label>End Date(saved): <?php echo $activitiesEndDate ?></label>
                                        ...
                                        <div class='col-12'>
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control-file" id="exampleFormControlFile1" name="filesubmit" value="<?php echo $activitiesFile ?>">
                                            </div>
                                        </div>
                                        <div class='col-12'>
                                            <div class="form-group">
                                                <label for="exampleFormControlFile1">Image Submit</label>
                                                <input type="file" class="form-control-file" id="exampleFormControlFile1" name="imagesubmit" value="<?php echo $activitiesImage ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class='col-12' style='padding: 15px'>
                                        <input type="hidden" name="activitiesID" value="<?php echo $activitiesID ?>">
                                    <button type="submit" class="btn btn-info" id="updateactivities" style="width:120px;" name="updateactivities">Submit</button>
                                    </div>
                                    <!-- /.box-body -->
                                </div>
                            </div>
