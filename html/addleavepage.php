...
if (isset($_POST['addleave'])) {
    ...
    $leaveStartDate = date('Y-m-d H:i:s', strtotime($_POST['startdate']));
    $leaveEndDate = date('Y-m-d H:i:s', strtotime($_POST['enddate']));
    $leaveDescirption = $_POST["description"];
    
    if ((strtotime($_POST['startdate'])) > (strtotime($_POST['enddate'])))
{
     echo "<script type='text/javascript'>alert('Failed Add, Please check the date validation!');history.go(-1)</script>";
}
else
{
    $query = "INSERT INTO tbl_leave(leaveID, staffID, reason_employee, leave_day_start, leave_day_end, status) VALUES('$leaveTitle-$staffID','$staffID','$leaveTitle, $leaveDescirption','$leaveStartDate','$leaveEndDate','Pending')";
    
    
    if (mysqli_query($conn, $query)) {
         echo "<script>
            alert('Success Add! $leaveTitle');
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="active"><a href="../html/addleavepage.php"><i class="fa fa-plus"></i> <span>Add Leave</span></a></li>
                ...
                <span>
                    ...
                    <small>
                        <ol class="breadcrumb" style="background-color: rgba(248, 244, 244, 0); position: absolute; top:6%; left:0.3%">
                            ...
                            <li class="active"><i class="fa fa-plus"></i> Add Leave</a></li>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="box box-danger">
                                    ...
                                    <button type="submit" class="btn btn-info" id="addleave" style="width:120px;" name="addleave">Submit</button>
                                    </div>
                                    <!-- /.box-body -->
                                </div>
                            </div>
